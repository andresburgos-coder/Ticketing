import { Controller, Get, Post, Body, Headers, HttpCode, HttpStatus, BadRequestException } from '@nestjs/common';
...
export class CsrfController {
  ...
  @ApiResponse({
    ...
    schema: {
      type: 'object',
      properties: {
        csrfToken: { type: 'string', description: 'CSRF token for form submission' }
      }
    }
  })
