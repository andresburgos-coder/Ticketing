...
describe('Email Value Object', () => {
  describe('create', () => {
    ...
    it('should throw InvalidEmailException for email without @', () => {
      expect(() => Email.create('userexample.com')).toThrow(InvalidEmailException);
      expect(() => Email.create('userexample.com')).toThrow('Invalid email format: userexample.com');
    });

    it('should throw InvalidEmailException for email without domain', () => {
      expect(() => Email.create('user@')).toThrow(InvalidEmailException);
      expect(() => Email.create('user@')).toThrow('Invalid email format: user@');
    });
    ...
    it('should throw InvalidEmailException for email with spaces', () => {
      expect(() => Email.create('user name@example.com')).toThrow(InvalidEmailException);
    ...
    it('should throw InvalidEmailException for email without TLD', () => {
      ...
      expect(() => Email.create('user@example')).toThrow('Invalid email format: user@example');
    });
  });
